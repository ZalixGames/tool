...
function loadDirectLinkAd() {
    const adContainer = document.getElementById('direct-link-ad-container');
    if (adContainer) {
        adContainer.innerHTML = `
            <a href="https://www.profitableratecpm.com/zi30dfhjnn?key=b78830ea0cb80a28c4b278ee2e122b06" 
               target="_blank" 
               rel="noopener noreferrer" 
               class="text-blue-500 hover:text-blue-600">
                <i class="fas fa-external-link-alt mr-2"></i>Visit our sponsor
            </a>
        `;
    }
}
